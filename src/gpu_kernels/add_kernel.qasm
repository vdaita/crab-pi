...
mov vr_setup, vpm_setup(1, 1, h32(4)) # read 16 rows, increment by 1 after each write, start at vpm coord 0,0
mov rb0, vpm
mov -, vr_wait
...
# mov vr_setup, vpm_setup(16, 2, h32(0)) # read 16 rows, increment by 1 after each read, start at vpm coord 0,0
# mov ra0, vpm
# mov -, vr_wait

# mov vr_setup, vpm_setup(16, 2, h32(4)) # read 16 rows, increment by 1 after each write, start at vpm coord 0,0
# mov rb0, vpm
# mov -, vr_wait

# mov vw_setup, vpm_setup(16, 2, h32(8))
# add r3, ra0, rb0
# mov vpm, r3
# mov -, vw_wait
